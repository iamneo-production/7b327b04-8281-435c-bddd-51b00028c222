...
const Navbar=()=>
{
    return(
        <div>
            ...
            <Link className="navbar-brand ps-3" to="/admin">Event Management System</Link>
            ...
            <form className="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                <div className="input-group">
                    <input className="form-control" type="text" placeholder="Admin Panel" aria-label="Search for..." aria-describedby="btnNavbarSearch" />
